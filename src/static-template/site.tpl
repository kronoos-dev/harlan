<div class="container">
    ...
    <div class="content">
        ...
        <div class="action secondary">
            <h3>Harlan traz conveniência a captura de dados para sua empresa graças ao uso da nuvem para armazenamento.</h3>
            <ul class="why-list">
                <li>
                    <i class="icon-time"></i>
                    <h4>Economize Tempo</h4>
                    <p>Suas dados estarão seguros, acessíveis sempre.</p>
                </li>
                <li>
                    <i class="icon-money"></i>
                    <h4>Economize Dinheiro</h4>
                    <p>Como diz o velho ditado, tempo é dinheiro.</p>
                </li>
                <li>
                    <i class="icon-safe"></i>
