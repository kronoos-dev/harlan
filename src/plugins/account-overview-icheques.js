...
harlan.addPlugin(controller => {
    ...
    controller.registerCall('myIChequesAccountOverview', function(callback, element, username, start, end, interval = 'P1W', method = 'append', closeable = false, contractType = null) {
        let ajaxQuery = {
            username: username,
            period: interval,
        ...
        controller.serverCommunication.call(controller.endpoint.myIChequesAccountOverview,
            controller.call('loader::ajax', controller.call('error::ajax', {
                ...
                success: function(response) {
                    var dataset = controller.call('myIChequesAccountOverview::dataset', $('BPQL > body > node', response));
