...
(function(controller) {
    ...
    controller.registerCall("myAccountOverview::dataset", function(responses) {
        var datasets = {};
    ...
    controller.registerCall("myAccountOverview::download", function(ajaxQuery, labels) {
    ...
    controller.registerCall("myAccountOverview", function(callback, element, username, start, end, interval = "P1W", method = "append", closeable = false, contractType = null) {
        let ajaxQuery = {
            username: username,
            period: interval,
        ...
        controller.serverCommunication.call(controller.endpoint.myAccountOverview,
            controller.call("loader::ajax", controller.call("error::ajax", {
                ...
                success: function(response) {
                    var dataset = controller.call("myAccountOverview::dataset", $("BPQL > body > node", response));
