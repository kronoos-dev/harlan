module.exports = controller => {
    ...
    controller.confirm({
        ...
        let inputPerformance = form.addInput('quality', 'number', 'Nota da Operação', {}, 'Nota de 0 até 10 da operação', 10).attr({
            min: 0,
            max: 10
        });

        let inputComments = form.addTextarea('comment', 'Comentários');
